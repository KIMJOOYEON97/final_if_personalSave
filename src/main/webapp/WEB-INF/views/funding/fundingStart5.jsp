...
<jsp:include page="/WEB-INF/views/common/makerNav.jsp" flush="false">
    ...
    <div class="container p-5">
        ...
        <!-- 다 체크해야 버튼 활성화되게 하기 -->
        <button class="btn btn-primary btn-lg" href="#" role="button" style="width: 200px;"  onclick="location.href='${pageContext.request.contextPath}/funding/ready1Funding';">시작하기</button>
